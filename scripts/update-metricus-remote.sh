...
DEFAULT_BUCKET="development-enterprise-site-management"

if [ $# -eq 0 ]; then
    echo "Usage: $0 <instance-id1> [instance-id2] [instance-id3] ... [-b bucket-name]"
    echo "Example: $0 i-021ef46178a035ed0 i-0123456789abcdef0"
    echo "Example: $0 i-021ef46178a035ed0 -b my-custom-bucket"
    exit 1
fi
...
COMMAND_ID=$(aws ssm send-command \
  ...
  --parameters "commands=[
    ...
    \"Copy-S3Object -BucketName $BUCKET_NAME -Key Update-metricus.ps1 -LocalFile \$scriptPath\",
    \"Copy-S3Object -BucketName $BUCKET_NAME -Key metricus-1.1.0.zip -LocalFile \$zipPath\",
