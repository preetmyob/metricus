...
// Type: Metricus.Plugins.GraphiteOut
// Assembly: GraphiteOut, Version=1.0.8808.32163, Culture=neutral, PublicKeyToken=null
// MVID: 0002F1D1-AAE0-4424-8115-C76BEAAAB889
// Assembly location: C:\temp\metricus-0.5.0\metricus-0.5.0\Plugins\GraphiteOut\GraphiteOut.dll
  ...
  public class GraphiteOut : OutputPlugin, IOutputPlugin
  {
    ...
    private void ShipToSumo(metric metric)
    {
      ...
      try
      {
        ...
        //var sumoHttpUrl = "https://collectors.au.sumologic.com/receiver/v1/http/ZaVnC4dhaV1bYaWGuS_ql2MSZ_11DhKlyvQC2jhwl0lt2TMJTjhekwJic-d1DFC6uzn1TOp4Ah96LZgtgeBQKN8GV33fEiRNBpU0jV2lmrv5yRuZZCnKAg==";

        var sumoHttpUrl2 = "https://collectors.au.sumologic.com/receiver/v1/http/ZaVnC4dhaV2e1CDB5rXgpEYrtxgp-bDMuE8EwVL31odca0bH2c-fQn4rXt-gtzjK9BBrs-MFO_cYpQmUDdKQC4Uu-AV8CekmdDTKvXpIx5ipe85q_13M_g==";
        var  response = client.PostAsync(sumoHttpUrl2, content).GetAwaiter().GetResult();
