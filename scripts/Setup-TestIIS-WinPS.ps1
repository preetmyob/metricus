...
<#
.SYNOPSIS
    Sets up a complete IIS test environment for Metricus metric collection (Windows PowerShell version).
...
.EXAMPLE
    .\Setup-TestIIS-WinPS.ps1
    
.EXAMPLE
    .\Setup-TestIIS-WinPS.ps1 -SiteName "MyTestSite" -Port 9090 -GenerateLoad $false
#>
...
# Main execution
try {
    Write-Host "Metricus IIS Test Environment Setup (Windows PowerShell)" -ForegroundColor Yellow
